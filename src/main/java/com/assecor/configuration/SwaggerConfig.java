...
public class SwaggerConfig
{
    ...
    public void postConstruct() throws ClassNotFoundException {
        ...
        for (BeanDefinition beanDef : provider.findCandidateComponents("com.exchange.resources")) {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .description("Endpoints related to Currency Exchange Services")
                .version("1.0")
                .contact(new Contact("Alok Maurya", "9876543210", "alokmaurya05@gmail.com"))
                .build();
    }
